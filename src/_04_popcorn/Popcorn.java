...
class Microwave {
	...
	Microwave() {
		System.out.println("A Microwave has been made.");
	}

	void putInMicrowave(Popcorn thingToBeCooked) {
		System.out.println("Your popcorn put in microwave.");
		this.thingToBeCooked = thingToBeCooked;
	}

	void setTime(int cookTimeInMinutes) {
		this.cookTime = cookTimeInMinutes;
		System.out.println("The cook time is set to " + cookTime + " minutes.");
	}

	void startMicrowave() {
		if (thingToBeCooked == null) {
			System.out.println("Oh no! There's nothing in the microwave!");
		} else {
...
public class Popcorn {
	...
	Popcorn(String flavor) {
		this.flavor = flavor;
		System.out.println("You are now making package of " + this.flavor + " popcorn.");
	}

	public void eat() {
		if (isCooked) {
			System.out.println(" Time to eat popcorn!");
		} else {
